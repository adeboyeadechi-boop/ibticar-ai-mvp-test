...
run_test "POST signin (invalid creds)" "POST" "/api/auth/signin" "500" '{"email":"test@test.com","password":"wrongpass"}'
run_test "GET /api/auth/me (no auth)" "GET" "/api/auth/me" "401"
run_test "POST /api/auth/refresh (no auth)" "POST" "/api/auth/refresh" "401"
